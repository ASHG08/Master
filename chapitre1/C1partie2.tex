...
\subsubsection{Les symboles chrétiens comme encadrement du pouvoir}

Nous l’avons évoqué en introduisant l’acceptation de la monarchie par Ambroise de Milan : la réussite d’un souverain unique passe inévitablement par le respect d'un contrat moral et par un encadrement strict du pouvoir. Cette restriction, que nous allons désormais analyser en détail, trouve sa source dans l'existence même de la foi chrétienne et dans sa présence au sein de la cour impériale à partir de la première moitié du IVe siècle. POur l'évêque, la légitimité du souverain a exploiter son pouvoir doit provenir d'une limitation innée, dictée par l'apprentissage des valeurs chrétiennes de la modération, la miséricorde et la piété. Mais ces aspects ne peuvent évidemment apparaître dans la pensée politique chrétienne qu'à partir du moment où les empereurs romain se mettent à adorer le Christ, ce qui se fait à partir de Constantin. Ambroise ancre sa théorie politique dans la continuité de ce tournant en montrant que les limitations apportées par le christianisme, sont aussi la source de stabilité et de réussite pour le gouvernement. Cette entrée de la foi chrétienne dans la vie politique romaine est synbolisé par Ambroise par un épisode bien précis : le récit de la découverte de la Croix du Christ et des clous de la Passion par Hélène, mère de Constantin\autocite[\nopp 41 à 52]{ambroise_mort_theodose}.

\bigskip

Ambroise est le premier en Occident à parler ainsi d'Hélène : il donne la description de la mère de l'empereur qui parvient à retrouver la Sainte Croix, ainsi que deux clous qui sont offerts à Constantin, sous la forme d'un diadème et d'un mors, pour représenter le guide de la foi et le frein des passions et de l'abus de pouvoir. Il est difficile de faire une approche strictement historique de ce mythe, car certains auteurs importants du règne de Constantin comme Eusèbe de Césarée qui n'aurait pas hésité à valoriser un tel évènement, n'en fait pas mention. C'est Cyrille de Jérusalem qui en parle pour la première fois en 348, en datant cet évènement vers 325\autocite[\nopp Introduction]{ambroise_mort_theodose}. Ambroise ne chercher d'ailleurs pas à entrer dans les détails historiques, il lui suffit de s'appuyer sur les rumeurs et la ferveur spirituel pour pour en tirer le récit qu'il souhaite et qui lui permet de documenter sa réflexion.

\bigskip

Ce récit est introduit lors de l'oraison funèbre à Théodose en 395, faisant donc une longue apparté théologique au sein d'un discours qui vise à valoriser le règne du défunt empereur. En réalité, si ce moment peut surprendre, il comporte deux objectifs importants pour notre analyse de la pensée politique ambrosienne. Premièrement, Ambroise veut montrer que l'arrivée du christinaisme chez les empereurs romains a permis une meilleure réalisation de la vie en société à travetrs des actions plus douces et justes. En parlant d'Hélène et de l'introduction des restrictions chrétiennes par la présence des clous sur les symboles du pouvoir impérial, l'évêque rappelle que Théodose a suivi avec soin cette foi, ce qui lui a valu la grandeur de son règne. Deuxièmement, il utilise ce moment officiel pour continué d'éduquer les futurs empereurs, et notamment Honorius, présent lors de la cérémonie. Si l'éducation personnelle du prince doit passer par l ´evocation de la morale chrétienne, tirée des clous du Christ, c'est bien la preuve qu'Ambroise déploie ici une grande partie de sa théorie politique en théorisant publiquement le bon gouvernement comme celui régi par les limitations chrétiennes.

\bigskip

C'ets ce qu l'on retoruve dans la description de l'utilisation des clous pour valoriser la foi des empereurs :
...
Cette citation permet une compréhension très précise de l’utilité du mythe des clous. Ambroise établit un lien direct entre cet héritage matéirel de la naissance du christianisme, et son installation à la tête de l'Empire. Il y a une symbolique chrétienne qui entre pleinement dans les outils de l'exercice du pouvoir, venant lier sur le long terme deux institutions jusqu'alors opposées. L'évêque de Milan en profite d'ailleurs pour parler de «~transmission de la foi aux empereurs suivants~» pour donner une légitimité aussi bien à la foi de Théodose qu'à ses propos. Il forge une forme de continuité de la chrétienté dans l'Empire, ce qui lui permet de montrer que les premières exigences liés à la piété et la fin des persécutions se sont propagées aux successeurs de COnstantin jusqu'aux empereurs contemporain d'Ambroise.

\bigskip

Ambroise poursuit son discours en appuyant sur l'encadrement du pouvoir par les symboliques chrétiennes et sur le rôle de l'empereur au coeur de la chrétienté :
