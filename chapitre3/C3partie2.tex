...
Ambroise questionne et théorise toujours sa façon d’agir, jusqu’à  son dialogue avec les empereurs. Il donne un aspect politique à ses interventions et ses lettres, tout en donnant cette même impression dans le sens inverse. C’est à dire qu’il rend pratiquement obligatoire, dans la pratique gouvernementale, le fait de se faire conseiller par un évêque, se présentant évidemment lui-même en tête de file.
...
\begin{quote}
    « Et que dira le Christ de vous à l'avenir ? Ne vous rappelez-vous pas ce qu'il dit à David par l’intermédiaire du prophète Nathan ?\footnote{«~\latin{Et quid de te Christus postea loquetur? Non recordaris quid per Nathan prophetam Dauid dixerit?}~» \cite[\nopp 40, 22]{ambroise_lettres}.}~»
\end{quote}
